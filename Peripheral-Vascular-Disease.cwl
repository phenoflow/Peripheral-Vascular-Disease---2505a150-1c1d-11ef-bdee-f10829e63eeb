...
steps:
  ...
  peripheral-vascular-disease-prosthesis---primary:
    run: peripheral-vascular-disease-prosthesis---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  peripheral-vascular-disease-cavity---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: peripheral-vascular-disease-prosthesis---primary/output
  ...
  peripheral-vascular-disease-valsalva---primary:
    run: peripheral-vascular-disease-valsalva---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  axillary-peripheral-vascular-disease---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: peripheral-vascular-disease-valsalva---primary/output
  ...
  peripheral-vascular-disease-obliteration---primary:
    run: peripheral-vascular-disease-obliteration---primary.cwl
    out:
    - output
    in:
      inputModule:
